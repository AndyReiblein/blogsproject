...
# BASE_DIR = Path(__file__).resolve().parent.parent # TODO: This might be required along with BASE_DIR below
...
SECRET_KEY = '7_4imhvyxos9gzc@&4k!46diqn3rs-h*5r(&s2u1$!s##6wjw='
